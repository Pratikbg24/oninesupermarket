...
using System.Data;
public partial class WebPages_CustLogin : System.Web.UI.Page
{
    ...
    protected void Btn_Login_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            flag1.Value = 'P';
            SqlParameter Email = cmd.Parameters.Add("@Cust_Email", SqlDbType.NVarChar);
            Email.Value = Txt_Email.Text;

            SqlParameter Pass = cmd.Parameters.Add("@Cust_Password", SqlDbType.NVarChar);
            ...
            if (ds.Tables["TT"].Rows.Count > 0)
            {
                try
                {
                    UserId = Int32.Parse(ds.Tables["TT"].Rows[0]["Cust_Id"].ToString());
                ...
                try
                {
                    UserName = ds.Tables["TT"].Rows[0]["Cust_Name"].ToString();
